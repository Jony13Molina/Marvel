...
public class Login extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get instance of user login
        userAuth = FirebaseAuth.getInstance();

        //request email and other google account information when loggin in
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken(getString(R.string.default_web_client_id))
                .requestEmail()
                .build();
        //build client instance to take care of request
    ...
    private void logIn(){
        Intent logInIntent = Auth.GoogleSignInApi.getSignInIntent(myGoogleApiClient);
